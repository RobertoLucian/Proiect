...
public class GUI {
  ...
  private void initialize() {
    ...
    frmBuilderPc
        .setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\coval\\Desktop\\New folder\\iconita.jfif"));
...
//Buton pentru stergere continut din TextField		
    ...
    // Buton preluare nume componenta din TextField si adaugare in una din
    // variantele CUSTOM
    ...
    btnADD.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (count == 0) {
          ...
          switch (p) {
          case "Procesor":
            comboProcesor.addItem(txtField.getText());
            break;
          case "Placa De Baza":
            comboPlacaDeBaza.addItem(txtField.getText());
            break;
          case "Placa Video":
            comboPlacaVideo.addItem(txtField.getText());
            break;
          case "RAM":
            comboRam.addItem(txtField.getText());
            break;
          case "Tip Racire":
            comboTipRacire.addItem(txtField.getText());
            break;
          case "Sursa":
            comboSursa.addItem(txtField.getText());
            break;
          case "Stocare":
            comboStocare.addItem(txtField.getText());
            break;
          }
